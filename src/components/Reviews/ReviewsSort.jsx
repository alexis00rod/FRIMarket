...
export const ReviewsSort = ({selected, ...props}) => {
  ...
  return (
    <div className="w-full max-w-sm flex items-center flex-wrap">
      <span className="px-2 flex flex-none text-sm font-medium">Ordenar por:</span>
      <div className="relative grow h-8">
        <button 
