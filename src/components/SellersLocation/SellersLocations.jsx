...
export const SellersLocations = ({selected,...props}) => {
  ...
  return (
    <div className="w-full max-w-sm px-2 py-2 flex flex-col">
      <span className="px-1 text-sm font-medium">Buscar por ubicacion:</span>
      <div className="relative w-full h-8">
        ...
        >
          <span className='h-full px-2 flex items-center grow'>
            {selected === 'all' ? 'Todas las ubicaciones' : locations.find(e => e.id === selected).nombre}
          </span>
