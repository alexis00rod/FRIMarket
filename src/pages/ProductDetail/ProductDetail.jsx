...
import { Breadcrumb, BreadcrumbLink, BtnAddCart, BtnAddWishlist, EditProduct, Loader, ProductDetailDate, ProductDetailLocation, ProductDetailUser, ProductReviews, ProductsDetailSimilar } from '../../components'
...
export const ProductDetail = () => {
  ...
  return (
    <>
      <Breadcrumb>
        {productDetail && <BreadcrumbLink name={productDetail.name} to={`/product/${id}`} />}
      </Breadcrumb>
