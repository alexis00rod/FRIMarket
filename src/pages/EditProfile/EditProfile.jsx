...
import { Breadcrumb, SelectCity, SelectProvince } from "../../components"
...
export const EditProfile = () => {
  ...
  return (
    ...
    <main className="w-full max-w-screen-2xl mx-auto px-2 py-4 flex flex-col grow">
      <form className="w-full max-w-xl px-2 pt-2 pb-4 mx-auto flex flex-col bg-white border border-gray-300 rounded-md divide-y divide-gray-300">
